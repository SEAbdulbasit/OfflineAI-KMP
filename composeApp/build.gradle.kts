...
android {
    namespace = "org.abma.offlinelai_kmp"
    compileSdk = libs.versions.android.compileSdk.get().toInt()

    defaultConfig {
        applicationId = "org.abma.offlinelai_kmp"
    ...
    buildTypes {
        ...
        getByName("debug") {
            // Generate AAB instead of APK to support files over 4GB
            // Or remove large model files from assets
        }
    }
    compileOptions {
